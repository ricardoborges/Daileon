<script lang="ts">
  ...
  import { Search, Layers, Server, Home, Sun, Moon, Settings, LogIn, LogOut, Globe, HelpCircle, GitFork } from 'lucide-svelte';
  ...
  $: links = [
    ...
    { href: '/graph', label: $t('graph.navLabel'), icon: GitFork },
